...
public class VideoPicker {
    ...
    private ArrayList<ImageItem> mSelectedVideos = new ArrayList<>();   //选中的图片集合
    private List<ImageFolder> mVideoFolders;      //所有的图片文件夹
    ...
    public List<ImageFolder> getVideoFolders() {
        return mVideoFolders;
    }

    public void setVideoFolders(List<ImageFolder> videoFolders) {
    ...
    /** 获取当前视频所在的文件夹 */
    public ArrayList<ImageItem> getCurrentVideoFolderItems() {
        return mVideoFolders.get(mCurrentVideoFolderPosition).images;
    }
    /** 是否选中该视频 checkbox*/
    ...
    public ArrayList<ImageItem> getSelectedVideos() {
...
//        takeRecordIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public interface OnVideoSelectedListener {
        void onVideoSelected(int position, ImageItem item, boolean isAdd);
    }
    /** 添加视频选中的监听 */
    ...
    private void notifyVideoSelectedChanged(int position, ImageItem item, boolean isAdd) {
        if (mVideoSelectedListeners == null) return;
