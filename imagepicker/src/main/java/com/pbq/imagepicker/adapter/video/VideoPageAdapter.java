...
public class VideoPageAdapter extends PagerAdapter {
    ...
    private ArrayList<ImageItem> videos = new ArrayList<>();
     ...
     * @param videos 视频数据源
     */
    public VideoPageAdapter(Activity activity, ArrayList<ImageItem> videos) {
    ...
    public void setData(ArrayList<ImageItem> videos) {
        this.videos = videos;
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final ImageItem videoItem = videos.get(position);
