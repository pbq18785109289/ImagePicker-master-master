...
public class VideoFolderAdapter extends BaseAdapter {
    ...
    private List<ImageFolder> videoFolders;
    private int lastSelected = 0;

    public VideoFolderAdapter(Activity activity, List<ImageFolder> folders) {
        mActivity = activity;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.videoCount.setText(mActivity.getString(R.string.folder_image_count, folder.images.size()));
