...
public class VideoGridActivity extends ImageBaseActivity implements VideoDataSource.OnVideosLoadedListener, VideoGridAdapter.OnVideoItemClickListener, VideoPicker.OnVideoSelectedListener, View.OnClickListener {
    ...
    private List<ImageFolder> mVideoFolders;   //所有的视频文件夹
    ...
    private void createPopupFolderList() {
        ...
        mFolderPopupWindow.setOnItemClickListener(new FolderPopUpWindow.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                mFolderPopupWindow.dismiss();
                ImageFolder videoFolder = (ImageFolder) adapterView.getAdapter().getItem(position);
                if (null != videoFolder) {
                    mVideoGridAdapter.refreshData(videoFolder.images);
    ...
    public void onVideosLoaded(List<ImageFolder> videoFolders) {
        ...
        else mVideoGridAdapter.refreshData(videoFolders.get(0).images);
        //视频点击的监听事件
     ...
     */
    @Override
    public void onVideoItemClick(View view, ImageItem videoItem, int position) {
        //根据是否有相机按钮确定位置
        ...
        if (videoPicker.isMultiMode()) {
            ...
            videoPicker.addSelectedImageItem(position, videoPicker.getCurrentVideoFolderItems().get(position), true);
            Intent intent = new Intent();
            intent.putExtra(VideoPicker.EXTRA_RESULT_VIDEO_ITEMS, videoPicker.getSelectedVideos());
     ...
     */
    @Override
    public void onVideoSelected(int position, ImageItem item, boolean isAdd) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == VideoPicker.REQUEST_VIDEO_TAKE) {
            ...
            videoPicker.clearSelectedVideos();
            //添加选中这个录像视频
            videoPicker.addSelectedImageItem(0, videoItem, true);
