...
public abstract class VideoPreviewBaseActivity extends ImageBaseActivity {
    ...
    protected ArrayList<ImageItem> mVideoItems;      //跳转进VideoPreviewFragment的视频文件夹
    protected int mCurrentPosition = 0;              //跳转进VideoPreviewFragment时的序号，第几个视频
    protected TextView mTitleCount;                  //显示当前视频的位置  例如  5/31
    protected ArrayList<ImageItem> selectedVideos;   //所有已经选中的视频
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoItems = (ArrayList<ImageItem>) getIntent().getSerializableExtra(VideoPicker.EXTRA_VIDEO_ITEMS);
